            ...
            public void onClick(View view) {
                ...
                if(enteredOtp.equals("")){
                    ...
                    if(enteredOtp.equals(generateOtp)){
                        Toast.makeText(TeacherOtp.this, "OTP matched", Toast.LENGTH_SHORT).show();
                        editText.setText("");
                        textView.setText("");
                        Intent i=new Intent(TeacherOtp.this,TeacherChangePassword.class);
                        startActivity(i);
                        finish();
                    }
                    else{
                        Toast.makeText(TeacherOtp.this, "OTP not matched", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void sendMessage() {
        ...
        StringRequest request=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(TeacherOtp.this, "error in network", Toast.LENGTH_SHORT).show();
            }
        });
