...
public class TeacherOtpForgetPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_teacher_otp_forget_password);
     enteredMobile=getIntent().getStringExtra("teacherMobile");
            ...
            public void onClick(View view) {
                ...
                if(enteredOtp.equals("")){
                    ...
                    if(enteredOtp.equals(generateOtp)){
                        Toast.makeText(TeacherOtpForgetPassword.this, "OTP matched", Toast.LENGTH_SHORT).show();
                        editText.setText("");
                        textView.setText("");
                        Intent i=new Intent(TeacherOtpForgetPassword.this,TeacherChangeForgetPassword.class);
                        i.putExtra("teacherMobile",enteredMobile);
                        startActivity(i);
                        finish();
                    }
                    else{
                        Toast.makeText(TeacherOtpForgetPassword.this, "OTP not matched", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void generateOtp(int count) {
        ...
        Log.d("123", "teacher generateOtp: "+generateOtp);
    }
    ...
    private void sendMessage() {
        ...
        StringRequest request=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(TeacherOtpForgetPassword.this, "error in network", Toast.LENGTH_SHORT).show();
            }
        });
