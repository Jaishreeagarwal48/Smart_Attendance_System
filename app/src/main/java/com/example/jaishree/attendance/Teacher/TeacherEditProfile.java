...
public class TeacherEditProfile extends AppCompatActivity {
    ...
    private void methodListener() {
        ...
        teacherProfileCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(TeacherEditProfile.this, TeacherPanel.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void FetchFromDatabase() {
        ...
        if(cursor!=null && cursor.moveToNext()){
            ...
            Log.d("123", "FetchFromDatabase: "+tId);
    ...
    private boolean checkGallerPermission() {
    ...
    private void getImage() {
        Glide.with(this).load(image).crossFade().diskCacheStrategy(DiskCacheStrategy.ALL).into(teacherProfilePic);
        teacherProfileChar.setVisibility(View.GONE);
    }
}
