...
import static com.example.jaishree.attendance.R.id.radioButtonPresent;
...
public class ViewAttendanceAdapter extends ArrayAdapter {
    ...
    public ViewAttendanceAdapter(Context context, int layoutResource, ArrayList<TakeAttendancePojo> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.viewattendance_list_item, null);
