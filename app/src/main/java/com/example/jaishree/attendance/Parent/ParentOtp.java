...
public class ParentOtp extends AppCompatActivity {
    ...
    private void getMobileNumber() {
        ...
        if(cursor!=null && cursor.moveToNext()){
            enteredMobile=cursor.getString(5);
        }
    }
            ...
            public void onClick(View view) {
                ...
                if (enteredOtp.equals("")) {
                    ...
                    if (enteredOtp.equals(generateOtp)) {
                        Toast.makeText(ParentOtp.this, "OTP matched", Toast.LENGTH_SHORT).show();
                        editText.setText("");
                        textView.setText("");
                        Intent i = new Intent(ParentOtp.this, ParentChangePassword.class);
                        startActivity(i);
                        finish();
                    } else {
                        Toast.makeText(ParentOtp.this, "OTP not matched", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void sendMessage() {
        ...
        StringRequest request=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ParentOtp.this, "error in network", Toast.LENGTH_SHORT).show();
            }
        });
