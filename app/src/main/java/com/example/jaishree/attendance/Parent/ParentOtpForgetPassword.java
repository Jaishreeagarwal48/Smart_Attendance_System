...
public class ParentOtpForgetPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parent_otp_forget_password);
        enteredMobile=getIntent().getStringExtra("parentMobile");
        init();
            ...
            public void onClick(View view) {
                ...
                if (enteredOtp.equals("")) {
                    ...
                    if (enteredOtp.equals(generateOtp)) {
                        Toast.makeText(ParentOtpForgetPassword.this, "OTP matched", Toast.LENGTH_SHORT).show();
                        editText.setText("");
                        textView.setText("");
                        Intent i = new Intent(ParentOtpForgetPassword.this, ParentChangePassword.class);
                        i.putExtra("parentMobile",enteredMobile);
                        startActivity(i);
                        finish();
                    } else {
                        Toast.makeText(ParentOtpForgetPassword.this, "OTP not matched", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private void generateOtp(int count) {
        ...
        Log.d("123", "parent generateOtp: "+generateOtp);
    }
    ...
    private void sendMessage() {
        ...
        StringRequest request=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ParentOtpForgetPassword.this, "error in network", Toast.LENGTH_SHORT).show();
            }
        });
